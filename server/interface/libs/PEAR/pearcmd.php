 ...
 * @nodep Gtk
 */
if ('M:\work\UniformServer5.6\UniServer\home\admin\www\plugins\pear\PEAR' != '@'.'include_path'.'@') {
    ini_set('include_path', 'M:\work\UniformServer5.6\UniServer\home\admin\www\plugins\pear\PEAR');
    $raw = false;
} else {
